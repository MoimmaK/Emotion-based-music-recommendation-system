...
df = pd.read_csv("D:\\dev\\AImaybe\\Emotion-based-music-recommendation-system\\muse_v3.csv")
...
model.load_weights('D:\\dev\\AImaybe\\Emotion-based-music-recommendation-system\\model.h5')
...
face = cv2.CascadeClassifier('D:\\dev\\AImaybe\\Emotion-based-music-recommendation-system\\haarcascade_frontalface_default.xml')
if face.empty():
